    ...
    def _mamba_block_aligned_split(
        ...
        if num_computed_tokens < max(request.num_prompt_tokens, request.num_tokens - 1):
            ...
            if self.block_size != self.cache_config.block_size:
                ...
                last_cache_position = num_tokens_total = request.num_tokens
                last_cache_position = num_tokens_total - num_tokens_total % block_size
                if self.use_eagle:
                ...
                if after < last_cache_position:
                    ...
                    if boundary > num_computed_tokens:
                        num_new_tokens = boundary - num_computed_tokens
